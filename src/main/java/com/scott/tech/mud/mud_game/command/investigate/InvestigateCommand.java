...
public class InvestigateCommand implements GameCommand {
    ...
    public CommandResult execute(GameSession session) {
        ...
        if (hiddenExits.isEmpty()) {
            return CommandResult.withAction(investigateAction, GameResponse.message(Messages.get("command.investigate.fallback")));
        }
        ...
        return CommandResult.withAction(investigateAction, responses.toArray(new GameResponse[0]));
    }
}
